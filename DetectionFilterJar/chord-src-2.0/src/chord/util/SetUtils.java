...
public class SetUtils {
	...
	/**
	 * Threshold that, given the estimated size of a set to be
	 * created, is used to decide whether to use a lightweight
	 * (e.g. ArraySet) or heavyweight (e.g. HashSet)
	 * implementation.
	 */
	 ...
	 * {@link #THRESHOLD} is used to choose the implementation of the
