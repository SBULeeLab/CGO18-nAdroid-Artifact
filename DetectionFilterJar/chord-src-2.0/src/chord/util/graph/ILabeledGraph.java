 ...
 * immutable view of a labeled, directed graph to clients even though
 * the underlying implementation may be that of a mutable graph.
 * <p>
...
public interface ILabeledGraph<Node, Label> extends IGraph<Node> {
	/**
	 * Provides the set of all labels on a given directed edge in
	 * the graph.
	 * 
