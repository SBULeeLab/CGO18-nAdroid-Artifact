...
/**
 * Algorithm for computing the Reverse Post Order (RPO) of the nodes
 * in a directed graph.
 * <p>
 * Notes:
 * <ul>
...
public final class RPOBuilder<Node> {
	/**
	 * Provides all nodes of a given directed graph reachable from
	 * its root nodes and ordered in Reverse Post Order (RPO).
	 * 
	 * @param	graph	A directed graph.
	 * 
	 * @return  All nodes of the given directed graph reachable from
	 *			its root nodes and ordered in RPO.
	 */
