...
public class Rel {
	 ...
	 * 
	 * @param	domNames	An ordered list of comma-separated
	 *			 domain names of this relation.
	 ...
	 * The signature must be set only once.
	 *
	 * @param	domNames	An ordered list of domain names of
	 *			 this relation.
	 * @param	domOrder	The BDD ordering of the domain names.
	 */
	public void setSign(String[] domNames, String domOrder) {
	 ...
	 * <p>
	 * The signature of the relation must be set before the domains
	 * are set.
	 * <p>
	...
	/**
	 * Sets this relation in memory to the full relation
	...
	/**
	 * Sets this relation in memory to the empty relation
	...
	protected void checkRange(Object val, int domIdx) {
		...
		if (idx >= size) {
			throw new RuntimeException(
				"Object " + val + " has out of range index " + idx +
				" in domain #" + domIdx + " named '" + doms[domIdx] +
				"' of size " + size +
				" in relation named '" + name + "'.");
		}
	...
	protected void checkRange(int idx, int domIdx) {
		...
		if (idx >= size) {
			throw new RuntimeException(
				"Value has out of range index " + idx +
				" in domain #" + domIdx + " named '" + doms[domIdx] +
				"' of size " + size +
				" in relation named '" + name + "'.");
		}
